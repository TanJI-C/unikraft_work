...
sudo qemu-system-x86_64  -fsdev local,id=myid,path=/home/ubuntu/hw/UKraft/docs/content/en/community/hackathons/sessions/baby-steps/work/03-mount-9pfs/fs0,security_model=none \
                         -device virtio-9p-pci,fsdev=myid,mount_tag=rootfs,disable-modern=on,disable-legacy=off \
                         -netdev bridge,id=en0,br=virbr0 \
                         -device virtio-net-pci,netdev=en0 \
                         -kernel build/03-mount-9pfs_qemu-x86_64 \
